...
public class ApacheHttpclientDocumentServerClientImpl extends AbstractDocumentServerClient
    ...
    protected <R> R executeRequest(final HttpClient client, final ClassicHttpRequest classicHttpRequest,
                                   final Callback<R> callback) {
        try {
            return client.execute(classicHttpRequest, response -> {
